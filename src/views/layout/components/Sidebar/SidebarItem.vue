<template>
  <div v-if="!item.hidden&&item.children&&hasPermission(item)" class="menu-wrapper">

    <router-link v-if="hasOneShowingChild(item.children) && !onlyOneChild.children&&!item.alwaysShow&&hasPermission(item)" :to="resolvePath(onlyOneChild.path)">
